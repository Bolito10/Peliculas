        ...
        <div>
            <form class="w-full max-w-sm" action="{{route('peliculas.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="md:flex md:items-center">
                    ...
                    <div class="md:w-2/3">
                        <button
                            class="shadow bg-blue-500 hover:bg-green-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded"
                            type="submit">
                            Guardar
                        </button>
                    </div>
